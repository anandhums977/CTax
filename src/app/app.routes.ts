...
import { DashboardComponent } from './features/roles/operations-manager/dashboard/dashboard.component';
...
export const routes: Routes = [
  ...
  { path: 'operations-manager-dahsboard', component: DashboardComponent },
];
